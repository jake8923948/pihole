<style><?php include '\echostyle.css'; ?></style>
...
$bpAskJake = !empty($svEmail) ? '<a href="mailto:'.$svEmail.'?subject=General Enquiry regarding adblock"></a>' : "<span/>";
